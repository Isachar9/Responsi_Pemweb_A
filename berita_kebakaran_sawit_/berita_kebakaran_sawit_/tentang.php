    ...
    <div class="container">
        <div class="row">
            <div class="col-12 fh5co_mediya_center"><a href="#" class="color_fff fh5co_mediya_setting"><i
                ...
                <div class="d-inline-block fh5co_trading_posotion_relative"><a href="#" class="treding_btn">Tentang Kami</a>
...
<div class="container-fluid bg-faded fh5co_padd_mediya padding_786">
    <div class="container padding_786">
        <nav class="navbar navbar-toggleable-md navbar-light ">
            ...
            <a class="navbar-brand" href="#"><img src="images/logo-1.png" alt="img" class=""/></a>
...
<div class="container-fluid contact_us_bg_img">
    <div class="container">
        <div class="row">
            ...
            <a href="#" class="fh5co_con pt-2"> Tentang Kami </a>
        </div>
    </div>
</div>
            ...
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        <span class="c_g d-block">Telepon</span>
            ...
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        ...
                        <span class="d-block c_g fh5co_contact_us_no_text">pprobert@email.com</span>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        ...
                        <span class="d-block c_g fh5co_contact_us_no_text"> Jl. Jalan No. 501</span>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
...
<div class="container-fluid mb-4">
    <div class="container" >
        <div class="col-12 text-center contact_margin_svnit ">
            <div class="text-center fh5co_heading py-2">Tentang Kami</div>
        
        </div>
        <div class="row">
            <div class="col-12">
                <p>Ini adalah program profesional Robert m</p>
            </div>
        </div>
    </div>
</div>
